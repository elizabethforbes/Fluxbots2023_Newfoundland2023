...
calculate_regressions_custom_intervals_list <- function(time_series_list, custom_intervals_df, 
  ...
  results_df <- data.frame(
    ...
    delta_kg_L = numberic(), # units in kg
    delta_kg_Q  = numberic(), # units in kg
    fluxL_kgm2sec = numberic(), # flux estimate in kg/m2/sec
    fluxQ_kgm2sec = numberic(), # flux estimate in kg/m2/sec
    fluxL_umolm2sec = numberic(), # flux estimate in umol/m2/sec
    fluxQ_umolm2sec = numberic()  # flux estimate in umol/m2/sec
  )
